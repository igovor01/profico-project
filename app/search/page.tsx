...
export default function Search() {
  ...
  const [searchMode, setSearchMode] = useState<SearchMode>({modeKeyword:"", label:"Everything"})
    ...
    <>
      <section className="w-full h-full flex flex-col lg:flex-row items-center justify-around relative bg-gradient-to-l from-amber-800 to-orange-950">
            <h1 className="relative text-white text-4xl text-center lg:text-start ml-9 mt-9">
              Here comes a really nice <br /> book quote that I will later
              update.
            </h1>
          <div className="w-max top-2.5 right-36 text-center flex flex-col items-center mr-20 mt-9">
            <h2 className="text-white text-2xl lg:text-4xl mt-5 mb-4">Find Your Book</h2>
            <section className="">
              <SearchBar
      ...
      {isResultSectionVisible && <ResultSection searchValue={searchValue} searchMode={searchMode}/>}
    </>
  );
}
